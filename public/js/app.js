    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.status === 422) {
          ...
          $("#signup-form")[0].reset();
          $(document).find("span#success-message").text(response.message);
          $("div#success-msg").css("display", "flex");
          setTimeout(function () {
            $("div#success-msg").css("display", "none"); // history.pushState(null, '', '/dashboard');
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.status === 409) {
          $(document).find("span#email-error-message").text(response.error);
          $("div#email-error-msg").css("display", "flex");
        } else {
          $(document).find("span#email-success-message").text(response.message);
...
$(document).ready(function () {
  ...
  updateEmail(); // create user account
