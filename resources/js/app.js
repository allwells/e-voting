...
$(document).ready(function () {
    ...
    // copy icons
    let copySuccessIcon = `<svg class="copy-success-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                           </svg>`;

    let copyIcon = `<svg class="copy-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    $(document).on("click", ".hamburger-btn", function () {
        ...
        if (opened) {
            $(".hamburger-menu").css("padding", "1.75rem");
            $(".hamburger-menu").css("visibility", "visible");
            $(".hamburger-menu").css("opacity", "1");
            $(".hamburger-menu").css("width", "100%");
        }
    });

    $(document).on("click", ".hamburger-btn-close", function () {
        opened = false;

        if (!opened) {
            $(".hamburger-menu").css("padding", "0");
            $(".hamburger-menu").css("visibility", "hidden");
            $(".hamburger-menu").css("opacity", "0");
            $(".hamburger-menu").css("width", "0");
        }
    });
});
