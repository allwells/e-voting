        ...
        <div class="flex flex-col w-full max-w-2xl gap-2">
            ...
            <form class="register-for flex flex-col gap-3" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="w-full flex flex-col md:flex-row gap-5">
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <input id="fname" name="fname" type="text"
                                class="relative block w-full h-11 px-3 mt-1 text-sm duration-300 border rounded-lg text-neutral-800 border-neutral-300 outline-0 hover:ring-0 hover:border-neutral-500 focus:outline-none focus:border-[#0000FF] focus:z-10"
                ...
                <div class="flex flex-col w-full gap-2 mt-3">
                    <button type="submit"
                        class="bg-[#0000FF] hover:bg-[#0000DD] focus:bg-[#0000DD] focus:ring focus:ring-[#0000FF]/30 rounded-lg font-bold py-3 text-white text-sm w-full">
                        Sign Up
                    </button>
