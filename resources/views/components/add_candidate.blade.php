...
<div id="authentication-modal" tabindex="-1" aria-hidden="true"
    class="hidden bg-neutral-900/50 backdrop-blur-sm overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-full justify-center items-center">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex justify-center items-center w-full">
                            <label for="dropzone-file"
                                class="flex flex-col justify-center items-center w-full transition duration-300 h-44 bg-neutral-50 rounded-lg border-2 hover:border-neutral-500 border-neutral-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-neutral-700 hover:bg-neutral-100 dark:border-neutral-600 dark:hover:border-neutral-400 dark:hover:bg-neutral-600">

                                <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                    <svg class="mb-3 w-10 h-10 text-neutral-400" fill="none" stroke="currentColor"
