...
<button type="button" data-modal-toggle="authentication-modal-{{ $election->id }}" title="Edit this election"
    class="block p-1 font-medium text-left transition duration-300 border-2 border-transparent rounded w-fit hover:bg-neutral-100 focus:border-neutral-400 dark:focus:border-neutral-500 dark:hover:bg-neutral-700/50">
...
<div id="authentication-modal-{{ $election->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full h-full max-w-3xl p-4 md:h-auto">
        ...
        <div
            class="relative bg-white border rounded-lg shadow dark:bg-neutral-900 border-neutral-100 dark:border-neutral-700">
            <button type="button"
                class="absolute top-3 right-2.5 rounded text-neutral-400 bg-transparent hover:bg-neutral-200 hover:text-neutral-900 text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-neutral-800 dark:hover:text-white"
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form id="update-election-form" class="flex flex-col items-center justify-start gap-2 mt-12"
                    ...
                    <div class="flex flex-col justify-center w-full gap-2 form-input-group md:flex-row">

                        {{-- election title input --}}
                        <div class="w-full md:w-6/12">
                            <label for="title"
                                class="text-sm font-semibold text-neutral-700 dark:text-neutral-200">Title
                    ...
                    <div class="flex flex-col justify-center w-full gap-2 mt-6 form-input-group md:flex-row">

                        {{-- election start date and time input --}}
                        <div class="flex w-full gap-2 md:w-6/12">
                            <div class="w-6/12">
                                <label for="start_date"
                                    class="text-sm font-semibold text-neutral-700 dark:text-neutral-200">Start Date
                                    <span class="text-rose-500">*</span>
                                </label>
                            ...
                            <div class="w-6/12">
                                <label for="start_time"
                                    class="text-sm font-semibold text-neutral-700 dark:text-neutral-200">Start Time
                                    <span class="text-rose-500">*</span>
                                </label>
                        ...
                        <div class="flex items-end justify-start w-full gap-2 md:w-6/12">
                            <div class="w-6/12">
                                <label for="end_date"
                                    class="text-sm font-semibold text-neutral-700 dark:text-neutral-200">End Date
                                    <span class="text-rose-500">*</span>
                                </label>
                            ...
                            <div class="w-6/12">
                                <label for="end_time"
                                    class="text-sm font-semibold text-neutral-700 dark:text-neutral-200">End Time
                                    <span class="text-rose-500">*</span>
                                </label>
                    ...
                    <div class="flex flex-col justify-center w-full gap-2 form-input-group md:flex-row">
                        ...
                        <div class="w-full md:w-6/12">
                            <label for="type"
                                class="text-sm font-semibold text-neutral-700 dark:text-neutral-200">Election
                                Type
                                <span class="text-rose-500">*</span>
                            </label>
                    ...
                    <div class="flex items-center justify-center w-full mt-5 lg:w-2/5 sm:w-3/5">
                        <button type="submit"
