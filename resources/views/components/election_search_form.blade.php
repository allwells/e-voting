<div class="flex items-center w-full">
    <label for="elections-search"
        class="mb-2 text-sm font-medium sr-only text-neutral-900 dark:text-neutral-300">Search</label>
    <div class="relative flex items-center justify-between w-full">

        <input type="search" id="elections-search"
            ...
            placeholder="Search election by title, status, privacy..." required>
    </div>
</div>
