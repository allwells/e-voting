    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col justify-start mt-16 align-middle sm:text-center lg:text-left">
            <div class="flex justify-center">
                <h1 class="text-4xl font-black tracking-tight text-center text-gray-900 sm:text-5xl md:text-6xl">
                    <span class="block xl:inline">Facilitate your</span>
                    <span class="block text-[#0000FF] xl:inline">online voting</span>
                </h1>
            </div>

            <div class="flex justify-center font-normal mt-3 align-middle sm:mt-5 md:mt-5 sm:mx-auto lg:mx-0">
            ...
            <div class="flex justify-center mt-3 align-middle sm:py-6 sm:mt-6 gap-5">
                <a href="{{ route('register') }}"
                    class="sm:px-8 sm:py-3 px-4 py-2 border border-[#0000FF] font-semibold @yield('no-nav') text-sm text-white
                ...
                <a href="#how-it-works"
                    class="sm:px-8 sm:py-3 px-4 py-2 font-semibold @yield('no-nav') text-sm text-neutral-600 transition duration-300 bg-white rounded-md border border-neutral-400 hover:text-[#0000FF] focus:border-[#0000FF] focus:text-[#0000FF] focus:ring focus:ring-[#0000FF]/30 hover:border-[#0000FF] h-fit w-fit">
                    See How It Works
                </a>
            </div>
        </div>
