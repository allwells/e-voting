    ...
    <div class="flex flex-col items-start justify-start w-full h-full px-3 pt-2 sm:justify-between">
        <ul class="w-full space-y-2">
            ...
            <li>
                <a href="{{ route('dashboard') }}" id="@yield('dashboard-tab')"
                    class="flex items-center h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200 dashboard-btn">
            ...
            @if (auth() && auth()->user()->privilege == 'admin')
                <li>
                    <a href="{{ route('candidates') }}" id="@yield('candidate-tab')"
                        class="flex items-center h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200 information-btn">
                ...
                {{-- <li>
                    <a href="#" id="@yield('register-tab')"
                        class="flex items-center h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200 register-btn">
            ...
            @if (auth() && auth()->user()->privilege == 'user')
                ...
                {{-- <li>
                    ...
                    <svg
                        class="flex items-center h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200 registration-btn">
            ...
            <li>
                <a href="{{ route('elections') }}" id="@yield('election-tab')"
                    class="flex items-center h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200 election-btn">
                    <svg class="flex-shrink-0 w-6 h-6 text-indigo-600 transition duration-75" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('results') }}" id="@yield('results-tab')"
                    class="flex items-center h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200 result-btn">
                    <svg class="flex-shrink-0 text-indigo-600 transition duration-75 w-7 h-7" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <span class="w-full">
            <a href="{{ route('settings') }}" id="@yield('settings-tab')"
                class="flex items-center h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200 settings-btn">
                <svg class="flex-shrink-0 w-6 h-6 text-indigo-600 transition duration-75" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <form id="logout-form" class="w-full mt-2" action="{{ route('logout') }}" method="post">
                ...
                <button
                    class="flex items-center justify-start w-full h-12 px-3 py-2 text-base font-normal transition duration-300 dark:hover:bg-neutral-800/50 hover:bg-neutral-100 active:bg-neutral-200"
