...
@section('views')
    <div
        ...
        @if (auth() && auth()->user()->privilege == 'admin' && (auth() && auth()->user()->privilege == 'superuser'))
            <div
        ...
        <div
            class="w-full min-h-full p-4 tracking-wide bg-white border rounded-lg shadow-lg shadow-neutral-300 dark:shadow-black md:p-8 dark:bg-neutral-900 border-neutral-100 dark:border-neutral-800 dark:ring-neutral-900 ring-1 ring-white">
                ...
                <table class="w-full mb-8 text-sm text-left text-neutral-500 dark:text-neutral-400">
                    <thead
                        ...
                        <tr>
                            ...
                            <th scope="col"
                                class="py-4 pl-4 text-left border-l border-neutral-100 dark:border-neutral-800">
                                Description
                            </th>
