...
@section('views')
    <form action="{{ route('settings.save') }}" method="POST"
        class="w-full bg-white gap-5 rounded-xl p-4 sm:p-5 flex flex-col">
        @csrf

        <div class="w-full flex md:flex-row flex-col gap-5">
            <div class="w-full md:w-6/12">
                <label class="text-neutral-600 font-medium text-base">Edit Profile</label>

                <div class="mt-3 border rounded-xl flex flex-col gap-3 p-3 sm:p-6">
                    <div>
            ...
            <div class="w-full md:w-6/12 flex flex-col gap-4">
                <div>
                    <label class="text-neutral-600 font-medium text-base">Change Password</label>
                ...
                <div>
                    <label class="text-neutral-600 font-medium text-base">Notifications</label>

                    <div class="mt-3 border rounded-xl flex flex-col gap-3 p-3 sm:p-6">
                        <div class="border rounded-md px-2 py-1 sm:px-4 sm:py-2 flex justify-between items-center">
        ...
        <div class="w-full flex justify-end items-center">
            <button type="submit"
                class="w-full sm:w-fit py-1.5 px-10 text-sm font-normal text-white rounded-md bg-indigo-600 shadow-lg hover:bg-indigo-700 focus:bg-indigo-700 focus:ring focus:ring-indigo-300">
                Save
            </button>
        </div>
    </form>
