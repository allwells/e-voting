    ...
    <form action="{{ route('settings.password') }}" method="POST"
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full">
                ...
                <div class="flex flex-col gap-4 p-3 py-6 mt-3 border rounded-md md:flex-row-reverse sm:rounded-xl md:px-4">
                    <div class="flex flex-col items-start justify-between w-full gap-4 md:w-3/5">
                        <div class="w-full">
                            ...
                            <input type="password" name="current_password" id="current_password"
                                ...
                                class="w-full px-3 mt-1 text-sm transition duration-300 border border-transparent rounded-md placeholder-neutral-400 bg-neutral-100 h-11 outline-0 text-neutral-600 hover:border-neutral-400 focus:border-indigo-600 focus:ring-0"
                                required />
                        </div>
